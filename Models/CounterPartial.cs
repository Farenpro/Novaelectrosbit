namespace Novaelectrosbit.Models
{
    ...
    {
        public string InstallDateStr { get { return InstallDate.ToString("dd.MM.yyyy"); } }
        public string BrandName { get { return CounterBrand.Name; } }
        public string MPIEndDateStr { get { return MPIEndDate.ToString("dd.MM.yyyy"); } }
        public string PlaceName { get { return InstallPlace.Name; } }
